...
namespace HCode21PracticeRound
{
    class CompromiseSolver
    {
        ...
        public CompromiseSolver(string inputFileName, string outputFileName, char delimiter)
        {
            ...
            // Compromise solver step #2 : add only best ingredients
            for (int i = 0; i < ingredients.Count; i++)
            {
                if (i < ingredients.Count * 0.25)
                    pizzaIngredients.Add(ingredients[i].Id, ingredients[i]);
            }
